...
#-----------------------------
process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:run2_data') # for 2018,2017 and 2016, GT for DATA
#process.GlobalTag = GlobalTag(process.GlobalTag, '102X_dataRun2_v14', '') # for 2018,2017 and 2016 DATA of EraA, EraB, EraC (Also upto EraF - but not sure)
#process.GlobalTag = GlobalTag(process.GlobalTag, '102X_dataRun2_Prompt_v16', '') # for 2018 DATA of EraD
# GT for MC
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        ...
        '/store/data/Run2017C/Charmonium/MINIAOD/31Mar2018-v1/00000/0208C5BC-5237-E811-845F-0CC47A7FC6D0.root',
...
process.TFileService = cms.Service("TFileService",
        fileName = cms.string('BctoBsPi-Data2017C_miniAOD.root'),
        #fileName = cms.string('BctoBsPi-Data2017D_miniAOD.root'),
        #fileName = cms.string('BctoBsPi-Data2017E_miniAOD.root'),
        #fileName = cms.string('BctoBsPi-Data2017F_miniAOD.root'),
)
