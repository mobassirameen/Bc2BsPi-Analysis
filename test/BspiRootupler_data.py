...
process.GlobalTag = GlobalTag(process.GlobalTag, '102X_dataRun2_v14', '') # for 2018,2017 and 2016 DATA of EraA, EraB, EraC
...
process.TFileService = cms.Service("TFileService",
        ...
        #fileName = cms.string('PvtMC-BsPi_FlatNtuple_06May2022.root'),
        #fileName = cms.string('BctoBsPi-Data2018A_miniAOD.root'),
        #fileName = cms.string('BctoBsPi-Data2018B_miniAOD.root'),
        #fileName = cms.string('BctoBsPi-Data2018C_miniAOD.root'),
        fileName = cms.string('BctoBsPi-Data2018D_miniAOD.root'),
